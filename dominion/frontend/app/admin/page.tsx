...
const QUICK_COMMANDS = [
  ...
  },
  {
    ...
    desc: "GRIMOIRE researches + ECHO publishes",
    agent: "echo",
    proposal: {
      title: "Content Pipeline Activation",
      description: "GRIMOIRE researches and synthesizes knowledge, ECHO drafts and publishes across all channels.",
      assignedTo: "ECHO",
      priority: "MEDIUM",
      steps: ["GRIMOIRE: research & outline", "ECHO: draft content", "Review & edit", "Publish"],
      estimatedCost: 1.2,
    },
  },
  {
    ...
    proposal: {
      ...
      description: "Full vulnerability scan of all exposed endpoints, SSL, CORS, and infrastructure health.",
      assignedTo: "WRAITH_EYE",
      priority: "CRITICAL",
      steps: ["Port scanning", "SSL/CORS audit", "Dependency check", "13-point health report"],
      estimatedCost: 2.0,
    },
  },
  {
    label: "💰 Financial Health Check",
    desc: "MAMMON audits treasury & spending",
    agent: "mammon",
    proposal: {
      title: "MAMMON Financial Health Check",
      description: "Full cost analysis, DCA tracking, budget vs actual, and war chest status.",
      assignedTo: "MAMMON",
      priority: "MEDIUM",
      steps: ["Collect cost data", "Check DCA status", "Analyze budget variance", "Generate treasury report"],
      estimatedCost: 0.8,
    },
  },
  {
    label: "📜 Research Deep Dive",
    desc: "GRIMOIRE investigates a topic",
    agent: "grimoire",
    proposal: {
      title: "GRIMOIRE Research Assignment",
      description: "Deep research and knowledge synthesis — EIPs, protocols, market analysis, or documentation.",
      assignedTo: "GRIMOIRE",
      priority: "MEDIUM",
      steps: ["Define scope", "Gather sources", "Synthesize findings", "Write report"],
      estimatedCost: 1.5,
    },
  },
];
